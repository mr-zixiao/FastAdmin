...
class SysLibrariesCRUD(CRUDBase[SysLibrariesModel, SysLibrariesCreateSchema, SysLibrariesUpdateSchema]):
    ...
    async def list_sys_libraries_crud(self, search: dict | None = None, order_by: list[dict] | None = None,
                                      preload: list | None = None) -> Sequence[SysLibrariesModel]:
        """
        列表查询
    ...
    async def page_sys_libraries_crud(self, offset: int, limit: int, order_by: list[dict] | None = None,
                                      search: dict | None = None, preload: list | None = None) -> dict:
        """
        分页查询
