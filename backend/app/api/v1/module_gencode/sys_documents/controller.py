...
SysDocumentsRouter = APIRouter(prefix='/sys_documents', tags=["文档管理模块"]) 

@SysDocumentsRouter.get("/detail/{id}", summary="获取文档管理详情", description="获取文档管理详情")
async def get_sys_documents_detail_controller(
    ...
    log.info(f"获取文档管理详情成功 {id}")
    return SuccessResponse(data=result_dict, msg="获取文档管理详情成功")

@SysDocumentsRouter.get("/list", summary="查询文档管理列表", description="查询文档管理列表")
async def get_sys_documents_list_controller(
    ...
    log.info("查询文档管理列表成功")
    return SuccessResponse(data=result_dict, msg="查询文档管理列表成功")

@SysDocumentsRouter.post("/create", summary="创建文档管理", description="创建文档管理")
async def create_sys_documents_controller(
    ...
    log.info("创建文档管理成功")
    return SuccessResponse(data=result_dict, msg="创建文档管理成功")

@SysDocumentsRouter.put("/update/{id}", summary="修改文档管理", description="修改文档管理")
async def update_sys_documents_controller(
    ...
    log.info("修改文档管理成功")
    return SuccessResponse(data=result_dict, msg="修改文档管理成功")

@SysDocumentsRouter.delete("/delete", summary="删除文档管理", description="删除文档管理")
async def delete_sys_documents_controller(
    ...
    log.info(f"删除文档管理成功: {ids}")
    return SuccessResponse(msg="删除文档管理成功")

@SysDocumentsRouter.patch("/available/setting", summary="批量修改文档管理状态", description="批量修改文档管理状态")
async def batch_set_available_sys_documents_controller(
    ...
    log.info(f"批量修改文档管理状态成功: {data.ids}")
    return SuccessResponse(msg="批量修改文档管理状态成功")

@SysDocumentsRouter.post('/export', summary="导出文档管理", description="导出文档管理")
...
@SysDocumentsRouter.post('/import', summary="导入文档管理", description="导入文档管理")
async def import_sys_documents_list_controller(
    ...
    return SuccessResponse(data=batch_import_result, msg="导入文档管理成功")

@SysDocumentsRouter.post('/download/template', summary="获取文档管理导入模板", description="获取文档管理导入模板", dependencies=[Depends(AuthPermission(["module_gencode:sys_documents:download"]))])
